...
import pt.com.rubira.dao.ClienteMapDAO;
import pt.com.rubira.dao.IClienteDAO;
import pt.com.rubira.domain.Cliente;
    ...
    public static void main(String[] args) {
        ...
        while (!isOpcaoValida(opcao)) {
            ...
            opcao = JOptionPane.showInputDialog(null,
                    "Opção invalida digite 1 para cadastro, 2 para consultar, 3 para exclusao, 4 para alteracao ou 5 para Sair" +
        ...
        while (isOpcaoValida(opcao)) {
            if (isOpcaoSair(opcao)) {
                ...
                String dados = JOptionPane.showInputDialog(null,
                        "Digite os dados do cliente separados por virgula, conforme exemplo: Nome, CPF, Tel, Endereço, Numero, Cidade e Estado " +
                                "Cadastro", JOptionPane.INFORMATION_MESSAGE);
                cadastrar(dados);
